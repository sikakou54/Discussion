...
export async function getWatcherIndex(_postId, _socketId, _userId) {
...
export async function getDiscussionMeeting(_postId) {
...
export async function getDiscussionAttendees(_postId) {
...
export async function getDiscussions(_country, _keys) {
...
export async function getDiscussionLimitTime(_postId) {
...
export async function getDiscussionMeetingAttendees(_meetingId, _socketId) {
    return await createAttendee(_meetingId, _socketId);
}

export async function getDiscussionMeetingConfig(_postId, _socketId) {
...
export async function getDiscussionResult(_postId) {
...
export async function getSocket(_type, _socketId) {
...
export async function getSockets(_type, _postId) {
...
export async function setPositiveState(_postId, _socketId, _userId, _state) {
...
export async function reSetPositiveState(_postId, _socketId, _userId) {
...
export async function setNegativeState(_postId, _socketId, _userId, _state) {
...
export async function reSetNegativeState(_postId, _socketId, _userId) {
...
export async function setWatcherState(_postId, _socketId, _userId, _state) {
...
export async function reSetWatcherState(_postId, _socketId, _userId) {
...
export async function setWatcherVote(_postId, _socketId, _userId, _judge) {
...
export async function setDiscussion(_country, _postId, _userId, _title, _detail, _positiveText, _negativeText) {
...
export async function setUpDiscussion(_country, _postId, _userId, _title, _detail, _positiveText, _negativeText) {
...
export async function setUser(_userId, _name) {
...
export async function setUserResult(_userId, _type, _count) {
...
export async function setDiscussionLimitTime(_postId, _limitTime) {
...
export async function setDiscussionProgress(_postId, _progress) {
...
export async function setDiscussionMeeting(_postId) {
...
export async function setDiscussionResult(_postId, _progress, _users) {
...
export async function setDiscussionPub(_postId, _pub) {
...
export async function joinDiscussionPositive(_postId, _socketId, _userId, _joinType) {
...
export async function joinDiscussionNegative(_postId, _socketId, _userId, _joinType) {
...
export async function joinDiscussionWatcher(_postId, _socketId, _userId, _joinType) {
...
export async function deleteSocket(_type, _socketId) {
...
export async function deleteDiscussionMeeting(_postId) {

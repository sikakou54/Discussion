                ...
                undefined !== data.state ?
                    (
                        <div className={styles.container}>
                            ...
                            {data.state === process.env.userState.online ? < Online isStart={data.isStarted} attendees={data.attendees} title={discussion.title} limitTime={data.limitTime} currentTime={data.currentTime} /> : null}
